...
public class DictionaryFactory {
	static final TreeMap <String, Integer> mapCuvinte = new TreeMap <> ();
        
	public TreeMap <String, Integer> WordCount(final Vector <Persoana> persoane) {
		 
		
		for(final Persoana inregistrare : persoane) {
